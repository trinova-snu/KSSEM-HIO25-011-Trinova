...
export const ChefHatIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 9c-1.67 0-3.2 .5-4.4 1.34-1.2 1-2.6 2.66-2.6 4.66V22h14v-7c0-2-1.4-3.65-2.6-4.66A6.83 6.83 0 0 0 12 9Z"></path>
    </svg>
);

export const TruckIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M10 17h4V5H2v12h3"></path><path d="M22 17h-1.32a2.4 2.4 0 0 0-2.32-1.87h-1.72a2.4 2.4 0 0 0-2.32 1.87H10"></path><path d="M22 17l-2-5h-4l-2 5"></path><circle cx="5" cy="17" r="2"></circle><circle cx="19" cy="17" r="2"></circle>
    </svg>
);

export const PackageIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M2 9.5l1.8-1.8L12 12l8.2-4.3L22 9.5" />
        <path d="M12 22.5L3 17V7L12 2l9 5v10l-9 5.5z" />
        <path d="M12 12v10.5" />
        <path d="M22 9.5V17" />
        <path d="M3.2 7L12 12l8.8-5" />
    </svg>
);
...
export const HandHeartIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M11 14h2a2 2 0 1 0 0-4h-3c-1.1 0-2 .9-2 2v1a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-1.5"></path>
        <path d="M12 6V3a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v1"></path>
        <path d="M22 13.2a4.2 4.2 0 0 0-6.1-4.4 4.2 4.2 0 0 0-6.2 4.4L12 21l6.1-7.8Z"></path>
    </svg>
);
...
export const FireIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M11.963 3.149C8.941 6.533 7 11.233 7 13a5 5 0 0 0 10 0c0-1.767-1.94-6.467-4.963-9.851a.91.91 0 0 0-1.074 0z"></path>
        <path d="M12 21c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3 3z"></path>
    </svg>
);
...
export const StoreIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m18 7-6 4-6-4"/><path d="m22 10-6 4-4-2.5-4 2.5-6-4"/>
      <path d="M2 18v-1.4l6-4 4 2.5 4-2.5 6 4V18"/>
...
export const BrainCircuitIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M21 13a3 3 0 1 0-5.993.142" />
        <path d="M12 19a3 3 0 1 0-5.993.142" />
        <path d="M5 13a3 3 0 1 0-5.993.142" />
        <path d="M12 5a3 3 0 1 0 5.993.142" />
        <path d="m14.243 6.757-.486 2.486" />
        <path d="m6.007 13.142-2.486-.486" />
        <path d="m14.243 17.243-.486 2.486" />
        <path d="m18.007 13.142 2.486-.486" />
        <path d="m9.757 6.757.486 2.486" />
        <path d="m9.757 17.243.486-2.486" />
    </svg>
);
...
export const LeafIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M15.21 15.21A7 7 0 0 1 15 22v-4.5"></path>
        <path d="M15 2h5a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-2"></path>
        <path d="M11 4h5"></path>
    </svg>
);
...
export const FridgeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const FactoryIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-7 5V8l-7 5V4H4a2 2 0 0 0-2 2z"></path>
